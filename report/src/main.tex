...
\begin{document}
    ...
    Constraints and critiques with trivial implementation have been omitted for brevity.
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{|p{0.21\linewidth}|p{0.4\linewidth}|p{0.39\linewidth}|}
            ...
            \hline
            Microservice & mustHaveDifferentJoinTablesForMultiple\-ManyToManyRelationships & Error if there are several many to many relationships using the same join table \\
            \hline
            ...
            \hline
            ClientDefinition & healthClientMustHaveOneHealth\-GetEndpoint &  \\
            \hline
