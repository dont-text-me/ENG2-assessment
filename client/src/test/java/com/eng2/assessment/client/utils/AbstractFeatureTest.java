 ...
 *
 * <p>Note: In order to cut down on test flakiness in CI (github actions), the test container is not
 * started and the compose file in the resources folder is ran manually instead.
 *
 * @link <a href =
